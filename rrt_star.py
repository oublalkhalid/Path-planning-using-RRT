...
def run(data_dic):
    ...
    for i in tqdm(data_dic["max_iter"]):
        ...
        for j in tqdm(range(10)): # avoid stochastic character 
            t0=current_milli_time()
            rrt = RrtStar(environment, x_start, x_goal, 2, 0.10,20, i)
...
if __name__ == '__main__':
    ...
    dataFrame.to_pickle("result_rrtSTAR_variation_iteMAX-100-50000.pkl")
